...
public class YaapSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String YAAP_CPU_MODEL_PROPERTY = "ro.yaap.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelYaap = SystemProperties.get(YAAP_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelYaap.isEmpty()) {
            return cpuModelYaap;
